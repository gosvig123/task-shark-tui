...
const help = [
  ...
  'Up / Down: select · Enter: open Task Workspace or mark a conversation read',
  'Task Workspace: 1/2/3 select stacked left sections; arrows preview items, Enter opens on right',
  'Escape: right pane to left sections, then back to the original task list',
  ...
  'd: task details · /: search · l: Task Lists · o: task filters · f: refresh tasks · Escape: clear filters',
